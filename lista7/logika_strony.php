...
if (isset($_GET["akcja"]) && $_GET["akcja"] == "nowy_przelew_oczekiwanie" &&
        isset($_POST["nrb"]) && isset($_POST["kwota"]) && isset($_POST["wyslij"])) {
    $bazaDanych->dodajPrzelew($_POST["nrb"], (int) $_POST["kwota"]);
}

if (isset($_GET["akcja"]) && $_GET["akcja"] == "nowy_przelew_get" &&
        isset($_GET["nrb"]) && isset($_GET["kwota"])) {
    $bazaDanych->dodajPrzelew($_GET["nrb"], (int) $_GET["kwota"]);
}
...
if (isset($_GET["akcja"]) && $_GET["akcja"] == "przelew_zatwierdzony_admin" && isset($_GET["id"])) {
    $bazaDanych->zatwierdzPrzelewAdmin($_GET["id"]);
}
